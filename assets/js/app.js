...
jQuery(function ($) {
  ...
  function submitContactForm() {console.log(    $('#contactForm textarea[name="message"]').val())
  ...
  $("#btnSubscription").click(function(){
    ...
    let email = $('#subscription').val();

  console.log("email",email)
 
 fetch("https://camelgateapi.wecancity.com/api/ar/NewsLetterEmail/Create",
{
    headers: {
...
.catch(function(res){ console.log(res) })
  ...
  console.log(email)
  console.log(name)
 fetch("https://camelgateapi.wecancity.com/api/ar/RequestForm/Create",
{
    headers: {
      'Accept': 'application/json',
      'Content-Type': 'application/json'
